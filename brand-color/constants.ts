...
export const COMBINATIONS: CombinationExample[] = [
  // LIGHT CATEGORY
  {
    title: "L1. 모던 화이트 & 샴페인",
    description:
      "청결함과 신뢰를 강조하는 표준 라이트 조합입니다. 깔끔한 첫인상을 주어야 하는 메인 상단에 적합합니다.",
    primary: "#9E1B1B",
    secondary: "#EBDE9A",
    accent: "#D9480F",
    bg: "#FFFFFF",
  ...
  },
  {
    ...
    description:
      "#FFFDF0에서 #FFFFFF로 흐르는 135도 사선 그래디언트로 세련된 입체감을 부여합니다. 콘텐츠가 많은 상세 페이지 배경으로 추천합니다.",
    primary: "#9E1B1B",
    secondary: "#FDFBF7",
    accent: "#B59410",
  ...
  },
  {
    title: "L3. 선셋 리니어 페이드",
    description:
      "좌측(White)에서 우측(#FFF9E6)으로 부드럽게 연결되는 수평 페이드입니다. ",
    primary: "#9E1B1B",
    secondary: "#F2E1A1",
    accent: "#FFFFFF",
  ...
  },
  {
    title: "L4. 순백의 샴페인 실크",
    description:
      "상단의 순백색(#FFFFFF)에서 하단의 프로스트 화이트(#FDFBF7)로 침잠하는 수직 페이드입니다. ",
    primary: "#9E1B1B",
    secondary: "#EBDE9A",
    accent: "#FDFBF7",
  ...
  },
  {
    ...
    description:
      "초저채도 골드(#FDFBF7)를 베이스로 여백의 미를 살려 정직함과 신뢰를 강조한 미니멀 조합입니다. 브랜드의 정직함을 전달할 때 효과적입니다.",
    primary: "#9E1B1B",
    secondary: "#F8F5F0",
    accent: "#EBDE9A",
    bg: "#FDFBF7",
  ...
  },
  {
    title: "L6. 노을의 약속",
    description:
      "수평으로 흐르는 미세한 붉은 기운이 사용자에게 편안한 안정감과 브랜드의 역동성을 동시에 전달합니다. 감성적인 스토리텔링 섹션에 적합합니다.",
    primary: "#9E1B1B",
    secondary: "#FFFDF0",
    accent: "#EBDE9A",
    ...
    isBgGradient: true,
    bgGradient:
      "linear-gradient(to right, #FFFDF0 0%, rgba(158, 27, 27, 0.04) 50%, #FDFBF7 100%)",
  },
  {
    title: "L7. 헤리티지 블러썸 페이드",
    description:
      "새벽녘의 붉은 기운을 닮은 부드러운 페이드 효과입니다. 원육의 신선함을 강조하거나 프리미엄 메뉴를 돋보이게 할 때 탁월합니다.",
    primary: "#9E1B1B",
    secondary: "#EBDE9A",
    accent: "#2D0B0B",
    ...
    isBgGradient: true,
    bgGradient:
      "linear-gradient(105deg, #FFFDF0 0%, #FDFBF7 60%, rgba(158, 27, 27, 0.08) 100%)",
  },
  {
    title: "L8. 선홍빛 새벽의 온기",
    description:
      "중앙에서 퍼져나가는 아주 연한 선홍빛의 방사형 그라디언트입니다. 브랜드의 생명력과 따스한 온기를 시각적으로 연출합니다.",
    primary: "#9E1B1B",
    secondary: "#FDFBF7",
    accent: "#EBDE9A",
  ...
  // DARK CATEGORY
  {
    title: "D1. 프리미엄 다크 골드",
    description:
      "모던 블랙(#1A1A1A) 위에 골드 텍스트를 배치한 정석적인 프리미엄 조합입니다. 고수익의 권위와 품격을 표현합니다.",
    primary: "#EBDE9A",
    secondary: "#B59410",
    accent: "#9E1B1B",
    bg: "#1A1A1A",
  ...
  },
  {
    ...
    description:
      "#1A1A1A에서 #4A0E0E로 흐르는 135도 사선 페이드로 강력한 시각적 인상을 남깁니다. 가맹 문의 버튼과 같은 핵심 행동 유도 섹션에 적합합니다.",
    primary: "#EBDE9A",
    secondary: "#9E1B1B",
    accent: "#FFFFFF",
  ...
  },
  {
    ...
    description:
      "어둠 속에서 타오르는 잉어불처럼 은은한 레드 글로우를 배치했습니다. 묵직한 무게감과 브랜드의 열정을 동시에 보여주는 다층 그라디언트입니다.",
    primary: "#EBDE9A",
    secondary: "#9E1B1B",
    accent: "#FFFFFF",
    ...
    isBgGradient: true,
    bgGradient:
      "radial-gradient(at 10% 20%, rgba(158, 27, 27, 0.25) 0px, transparent 40%), radial-gradient(at 80% 50%, rgba(235, 222, 154, 0.1) 0px, transparent 40%), #1A1A1A",
  },
  {
    title: "D4. 미드나잇 헤리티지",
    description:
      "좌상단 방사형(Radial) 레드 광채가 블랙 배경과 만나는 드라마틱한 연출입니다. 브랜드의 자부심을 상징적으로 표현할 때 효과적입니다.",
    primary: "#EBDE9A",
    secondary: "#9E1B1B",
    accent: "#FFFFFF",
  ...
  },
  {
    ...
    description:
      "3색 다층적 오로라 효과가 현대적이고 감각적인 분위기를 조성합니다. 브랜드 홍보 영상의 배경이나 메인 시네마틱 섹션에 최적입니다.",
    primary: "#EBDE9A",
    secondary: "#9E1B1B",
    accent: "#FFFFFF",
    ...
    isBgGradient: true,
    bgGradient:
      "radial-gradient(at 0% 0%, rgba(158, 27, 27, 0.2) 0px, transparent 50%), radial-gradient(at 100% 100%, rgba(235, 222, 154, 0.1) 0px, transparent 50%), #1A1A1A",
  },
  {
    title: "D6. 금빛 성류석의 잔상",
    description:
      "좌상단에 샴페인 골드의 빛 번짐(Glow)을 추가하여 성공의 광채를 표현했습니다. 깊이감을 유지하면서도 시선을 명확하게 집중시키는 효과가 있습니다.",
    primary: "#EBDE9A",
    secondary: "#2D0B0B",
    accent: "#FFFFFF",
    ...
    isBgGradient: true,
    bgGradient:
      "linear-gradient(135deg, #1A1A1A 0%, #2D0B0B 100%), radial-gradient(at 0% 0%, rgba(235, 222, 154, 0.15) 0px, transparent 50%)",
  },
  {
    title: "D7. 명장의 버건디 묵향",
    description:
      "Deep Burgundy를 메인으로 활용한 압도적 무게감입니다. 전문적인 원육 숙성 노하우나 브랜드의 핵심 가치를 전달하는 섹션에 사용하십시오.",
    primary: "#EBDE9A",
    secondary: "#9E1B1B",
    accent: "#FFFFFF",
  ...
  },
  {
    title: "D8. 성공의 붉은 나침반",
    description:
      "코닉 그라디언트를 활용하여 중심에서 뻗어 나가는 현대적 시각 효과를 줍니다. 본사의 비전이나 확장성을 보여주는 미래 지향적 페이지에 적합합니다.",
    primary: "#EBDE9A",
    secondary: "#9E1B1B",
    accent: "#FFFFFF",
